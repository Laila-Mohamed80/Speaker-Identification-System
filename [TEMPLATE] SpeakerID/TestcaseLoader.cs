...
namespace Recorder
{
    ...
    static class TestcaseLoader
    {
        ...
        static public double CheckTestcaseAccuracy(List<User> testCase, List<string> testcaseResult)
        {
            ...
            int resultIndex = 0;
            Console.WriteLine("testcaseResult.Count: " + testcaseResult.Count);
            Console.WriteLine("testCase.Count: " + testCase.Count);
            ...
            Console.WriteLine("misclassifiedSamples: " + misclassifiedSamples);
